  ...
  return (
    <div className="PopupSwiperWrapper">
      <div className="PopupSwiperContainer">
        <div className="PopupSwiperHeaderContainer">
          {/* <motion.div
          ...
          <div className="PopupSwiperArrowContainer">
        ...
        <Swiper
          ...
          modules={[Pagination, FreeMode, Navigation, EffectFade]}
          breakpoints={{
            1600: {
              slidesPerView: 4,
              spaceBetween: 30,
          ...
          {PopupSliderData.map((swiperData, index) => (
            <SwiperSlide className="PopupSwiperCardOuter" key={index}>
              <div className="PopupSwiperCardWrapper" onClick={() => handleImageClick(index)}>
                ...
                <div className="PopupSwiperContent">
                  <div className="swiperCardHeader">
                    <p className="PopupswiperCardHeaderInner">{swiperData.header}</p>
                  </div>
